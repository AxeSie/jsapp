...
const my_access_url = "http://127.0.0.1:8000/api/token/refresh/";
const my_refresh_url = "http://127.0.0.1:8000/api/token/";
const my_register_url = "http://127.0.0.1:8000/api/register/";
const my_reset_url = "http://127.0.0.1:8000/api/reset/";
let log_path = '';
let prog_path = '';
let my_game_handle ='';
